    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post_active_score', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(choices=[('G', 'Gold'), ('S', 'Silver'), ('B', 'Bronze')], default='S', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('placed_at', models.DateTimeField(auto_now_add=True)),
                ('payment_status', models.CharField(choices=[('pending', 'PENDING'), ('completed', 'COMPLETED'), ('failed', 'FAILED')], max_length=50, null=True)),
                ('delivery_status', models.CharField(choices=[('pending', 'PENDING'), ('completed', 'COMPLETED'), ('failed', 'FAILED')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('junk', models.CharField(blank=True, default='', max_length=250, null=True)),
